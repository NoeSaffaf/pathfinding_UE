...
public class RequestSuccessorNodeInfo implements Serializable {
    ...
    public RequestSuccessorNodeInfo(String nodeURI, String parentNodeURI, String goalAgent, List<String> ancestorList) {
